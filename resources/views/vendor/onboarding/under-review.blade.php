...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto text-center">
        <div class="bg-white shadow-md rounded-lg p-8">
            ...
            <h1 class="text-3xl font-bold mb-4">{{ __('Application Under Review') }}</h1>
            
            <p class="text-gray-600 mb-6">
                {{ __('Thank you for submitting your vendor application. Our team is currently reviewing your information.') }}
            </p>
