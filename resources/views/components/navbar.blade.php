...
<a class="flex flex-col items-center gap-1 {{ request()->is('/') ? 'text-primary' : 'text-gray-400' }}" href="/">
<span class="material-symbols-outlined text-2xl {{ request()->is('/') ? 'fill-current' : '' }}">home</span>
