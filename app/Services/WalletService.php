...
class WalletService
{
    ...
    public function processInvoicePayment(Invoice $invoice): void
    {
        ...
        $vendorOrders = \App\VendorOrder::where('order_id', $order->id)->get();
     ...
     */
    private function creditVendorAccount(\App\VendorOrder $vendorOrder, Invoice $invoice): void
    {
        $vendor = \App\Models\Vendor::find($vendorOrder->vendor_id);
