            ...
            <template v-else>
                ...
                <div v-else class="table-responsive grid w-full">
                    <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                        <!-- Placeholder Image -->
                        <img
                            src="<?php echo e(asset('vendor/webkul/admin/assets/images/empty-placeholders/orders.svg')); ?>"
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\customers\customers\view\orders.blade.php ENDPATH**/ ?>