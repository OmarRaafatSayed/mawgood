...
<?php if (! $__env->hasRenderedOnce('503ed081-9857-4660-afc5-b1e6c369ee4f')): $__env->markAsRenderedOnce('503ed081-9857-4660-afc5-b1e6c369ee4f');
                ...
                <div class="flex items-center gap-4">
                    <template v-if="isAddingToCart || isUpdating">
                        <img
                            ...
                            src="<?php echo e(asset('vendor/webkul/admin/assets/images/spinner.svg')); ?>"
                        />
                    </template>
                            ...
                            >
                                <template v-if="! item.product.images.length">
                                    <img
                                        ...
                                        src="<?php echo e(asset('vendor/webkul/admin/assets/images/product-placeholders/front.svg')); ?>"
                                    >
                                ...
                                >
                                    <template v-if="! product.images.length">
                                        <img
                                            ...
                                            ?>
                                            src="<?php echo e($frontPlaceholder); ?>"
                                        >
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\sales\orders\create\cart\items.blade.php ENDPATH**/ ?>