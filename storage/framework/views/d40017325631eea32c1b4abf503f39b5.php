...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.media.images','data' => ['name' => 'images[files]','allowMultiple' => 'true','showPlaceholders' => 'false','uploadedImages' => $product->images]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'images[files]','allow-multiple' => 'true','show-placeholders' => 'false','uploaded-images' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->images)]); ?>
...
<?php echo view_render_event('bagisto.admin.catalog.product.edit.form.images.after', ['product' => $product]); ?><?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src/resources/views/catalog/products/edit/images.blade.php ENDPATH**/ ?>