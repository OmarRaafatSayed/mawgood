<?php $__env->startSection('title', 'إعدادات المتجر'); ?>
<?php $__env->startSection('page-title', 'إعدادات المتجر'); ?>
<?php $__env->startSection('page-icon', '<i class="fas fa-store me-2"></i>'); ?>
                    ...
                    <div class="card-body">
                        <form id="profile-form">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="first_name" value="<?php echo e(auth('customer')->user()->first_name ?? ''); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">الاسم الأخير</label>
                                        <input type="text" class="form-control" name="last_name" value="<?php echo e(auth('customer')->user()->last_name ?? ''); ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="email" value="<?php echo e(auth('customer')->user()->email ?? ''); ?>" required>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">رقم الهاتف</label>
                                <input type="tel" class="form-control" name="phone" value="<?php echo e(auth('customer')->user()->phone ?? ''); ?>">
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">تاريخ الميلاد</label>
                                <input type="date" class="form-control" name="date_of_birth" value="<?php echo e(auth('customer')->user()->date_of_birth ?? ''); ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="gender">
                                    ...
                                    <option value="male" <?php echo e((auth('customer')->user()->gender ?? '') == 'male' ? 'selected' : ''); ?>>ذكر</option>
                                    <option value="female" <?php echo e((auth('customer')->user()->gender ?? '') == 'female' ? 'selected' : ''); ?>>أنثى</option>
                                </select>
                            </div>
                    ...
                    <div class="card-body">
                        <form id="store-form">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="store_name" value="<?php echo e($vendor->store_name ?? ''); ?>" required>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">رابط المتجر</label>
                                <div class="input-group">
                                    <span class="input-group-text"><?php echo e(url('/')); ?>/store/</span>
                                    <input type="text" class="form-control" name="store_slug" value="<?php echo e($vendor->store_slug ?? ''); ?>" required>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="store_description" rows="4" placeholder="اكتب وصفاً مختصراً عن متجرك"><?php echo e($vendor->store_description ?? ''); ?></textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">شعار المتجر</label>
                                <input type="file" class="form-control" name="store_logo" accept="image/*">
                                <?php if(isset($vendor->store_logo)): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e($vendor->store_logo); ?>" alt="Store Logo" class="img-thumbnail" style="max-width: 150px;">
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(isset($vendor->store_banner)): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e($vendor->store_banner); ?>" alt="Store Banner" class="img-thumbnail" style="max-width: 300px;">
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="established_year" min="1900" max="<?php echo e(date('Y')); ?>" value="<?php echo e($vendor->established_year ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <form id="contact-form">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="address" rows="3" placeholder="العنوان الكامل للمتجر"><?php echo e($vendor->address ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="postal_code" value="<?php echo e($vendor->postal_code ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" name="business_phone" value="<?php echo e($vendor->business_phone ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">البريد الإلكتروني للمتجر</label>
                                        <input type="email" class="form-control" name="business_email" value="<?php echo e($vendor->business_email ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" name="website" value="<?php echo e($vendor->website ?? ''); ?>" placeholder="https://example.com">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="url" class="form-control" name="facebook" value="<?php echo e($vendor->facebook ?? ''); ?>" placeholder="https://facebook.com/yourpage">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">إنستغرام</label>
                                        <input type="url" class="form-control" name="instagram" value="<?php echo e($vendor->instagram ?? ''); ?>" placeholder="https://instagram.com/yourpage">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <form id="hours-form">
                            ...
                            <div id="business-hours-container">
                                ...
                                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $dayName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row align-items-center mb-3">
                                    <div class="col-md-2">
                                        <div class="form-check">
                                            <input class="form-check-input day-checkbox" type="checkbox" id="<?php echo e($day); ?>" name="days[]" value="<?php echo e($day); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <input type="time" class="form-control" name="<?php echo e($day); ?>_open" placeholder="وقت الفتح">
                                    </div>
                                    <div class="col-md-1 text-center">
                                        <span>إلى</span>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="time" class="form-control" name="<?php echo e($day); ?>_close" placeholder="وقت الإغلاق">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="bank_name" value="<?php echo e($vendor->bank_name ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">رقم الحساب</label>
                                        <input type="text" class="form-control" name="account_number" value="<?php echo e($vendor->account_number ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="account_holder" value="<?php echo e($vendor->account_holder ?? ''); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">IBAN (اختياري)</label>
                                        <input type="text" class="form-control" name="iban" value="<?php echo e($vendor->iban ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="vodafone_cash" value="<?php echo e($vendor->vodafone_cash ?? ''); ?>" placeholder="01xxxxxxxxx">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">أورانج موني</label>
                                        <input type="text" class="form-control" name="orange_money" value="<?php echo e($vendor->orange_money ?? ''); ?>" placeholder="01xxxxxxxxx">
                                    </div>
                                </div>
                            </div>
...
document.getElementById('profile-form').addEventListener('submit', function(e) {
    e.preventDefault();
    submitForm(this, '<?php echo e(route("vendor.settings.profile.update")); ?>', 'تم تحديث الملف الشخصي بنجاح');
});

document.getElementById('store-form').addEventListener('submit', function(e) {
    e.preventDefault();
    submitForm(this, '<?php echo e(route("vendor.settings.index")); ?>', 'تم تحديث معلومات المتجر بنجاح');
});

document.getElementById('contact-form').addEventListener('submit', function(e) {
    e.preventDefault();
    submitForm(this, '<?php echo e(route("vendor.settings.index")); ?>', 'تم تحديث معلومات الاتصال بنجاح');
});

document.getElementById('hours-form').addEventListener('submit', function(e) {
    e.preventDefault();
    submitForm(this, '<?php echo e(route("vendor.settings.index")); ?>', 'تم تحديث ساعات العمل بنجاح');
});

document.getElementById('payment-form').addEventListener('submit', function(e) {
    e.preventDefault();
    submitForm(this, '<?php echo e(route("vendor.settings.index")); ?>', 'تم تحديث معلومات الدفع بنجاح');
});

document.getElementById('notifications-form').addEventListener('submit', function(e) {
    e.preventDefault();
    submitForm(this, '<?php echo e(route("vendor.settings.index")); ?>', 'تم تحديث إعدادات الإشعارات بنجاح');
});
...
document.querySelector('input[name="store_slug"]').addEventListener('input', function() {
    ...
    slugTimeout = setTimeout(() => {
        fetch('<?php echo e(route("vendor.onboarding.check-slug")); ?>', {
            method: 'POST',
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Mawgood\Vendor\src\Resources\views\settings\index.blade.php ENDPATH**/ ?>