            ...
            <div style="padding: 30px;">
                ...
                <div style="margin-bottom: 65px;">
                    <a href="<?php echo e(route('shop.home.index')); ?>">
                        ...
                        <?php else: ?>
                            <img
                                src="<?php echo e(asset('vendor/webkul/admin/assets/images/logo.svg', 'admin')); ?>"
                                alt="<?php echo e(config('app.name')); ?>"
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\emails\layout.blade.php ENDPATH**/ ?>