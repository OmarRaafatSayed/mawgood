...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-5 max-[1180px]:gap-x-3">
        ...
        <div class="flex items-center gap-2">
            ...
            <a
                href="<?php echo e(route('shop.cms.page', 'contact-us')); ?>"
                class="flex h-[77px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue px-2 text-sm font-medium"
            >
                اتصل بنا
            </a>
            ...
            <a
                href="<?php echo e(route('shop.cms.page', 'customer-service')); ?>"
                class="flex h-[77px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue px-2 text-sm font-medium"
            >
                خدمة العملاء
            </a>
            ...
            <a
                href="<?php echo e(route('shop.cms.page', 'privacy-policy')); ?>"
                class="flex h-[77px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue px-2 text-sm font-medium"
            >
                سياسة الخصوصية
            </a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.dropdown.index','data' => ['position' => 'bottom-'.e(data_get(core()->getCurrentLocale(), 'direction') === 'ltr' ? 'right' : 'left').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['position' => 'bottom-'.e(data_get(core()->getCurrentLocale(), 'direction') === 'ltr' ? 'right' : 'left').'']); ?>
...
<?php if (! $__env->hasRenderedOnce('4921c13d-08ab-4f72-aadb-41fa1a080ac0')): $__env->markAsRenderedOnce('4921c13d-08ab-4f72-aadb-41fa1a080ac0');
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Shop\src/resources/views/components/layouts/header/desktop/bottom.blade.php ENDPATH**/ ?>