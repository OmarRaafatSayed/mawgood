        ...
        <div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] py-4 max-lg:px-8 max-sm:px-4">
            <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
                ...
                >
                    ...
                    ?>
                    <img
                        src="<?php echo e($logoUrl ?: bagisto_asset('images/logo.svg')); ?>"
                        alt="<?php echo e(config('app.name')); ?>"
                        width="131"
                        height="29"
                        onerror="this.src='<?php echo e(bagisto_asset('images/logo.svg')); ?>'"
                    >
                </a>
            </div>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('d3a657ec-ebd0-4857-aa98-b364678954d9')): $__env->markAsRenderedOnce('d3a657ec-ebd0-4857-aa98-b364678954d9');
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Shop\src/resources/views/checkout/onepage/index.blade.php ENDPATH**/ ?>