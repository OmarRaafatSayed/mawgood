<?php $__env->startSection('title', 'المحفظة والمالية'); ?>
<?php $__env->startSection('page-title', 'المحفظة والمالية'); ?>
<?php $__env->startSection('page-icon', '<i class="fas fa-wallet me-2"></i>'); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="available-balance"><?php echo e(number_format($stats['wallet']['available'] ?? 0, 2)); ?></h2>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="unavailable-balance"><?php echo e(number_format($stats['wallet']['unavailable'] ?? 0, 2)); ?></h2>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="pending-withdrawals"><?php echo e(number_format($stats['wallet']['pending_payouts'] ?? 0, 2)); ?></h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <strong class="text-success"><?php echo e(number_format($stats['revenue']['total'] ?? 0, 2)); ?> جنيه</strong>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span>أرباح هذا الشهر:</span>
                    <strong class="text-primary"><?php echo e(number_format($stats['revenue']['monthly'] ?? 0, 2)); ?> جنيه</strong>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <strong class="text-success"><?php echo e(number_format(($stats['revenue']['total'] ?? 0) * 0.95, 2)); ?> جنيه</strong>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody id="transactions-tbody">
                    ...
                    <tr>
                        <td><?php echo e($transaction->created_at ? $transaction->created_at->format('Y-m-d H:i') : 'N/A'); ?></td>
                        <td>
                            <?php
                                $typeConfig = [
                            ...
                            ?>
                            <i class="<?php echo e($config['icon']); ?> text-<?php echo e($config['class']); ?> me-2"></i>
                            <?php echo e($config['text']); ?>

                        </td>
                        <td><?php echo e($transaction->description ?? 'معاملة'); ?></td>
                        <td>
                            <span class="text-<?php echo e($transaction->amount > 0 ? 'success' : 'danger'); ?>">
                                <?php echo e($transaction->amount > 0 ? '+' : ''); ?><?php echo e(number_format($transaction->amount ?? 0, 2)); ?> جنيه
                            </span>
                        </td>
                        <td>
                            <?php
                            ...
                            ?>
                            <span class="badge bg-<?php echo e($sConfig['class']); ?>"><?php echo e($sConfig['text']); ?></span>
                        </td>
                        <td><?php echo e(number_format($transaction->balance_after ?? 0, 2)); ?> جنيه</td>
                    </tr>
            ...
            <form id="withdrawal-form">
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        الرصيد المتاح للسحب: <strong><?php echo e(number_format($stats['wallet']['available'] ?? 0, 2)); ?> جنيه</strong>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label">المبلغ المطلوب سحبه</label>
                        <div class="input-group">
                            <input type="number" class="form-control" name="amount" step="0.01" min="10" max="<?php echo e($stats['wallet']['available'] ?? 0); ?>" required>
...
function loadEarningsData(period) {
    fetch(`<?php echo e(route("vendor.wallet.earnings_chart")); ?>?period=${period}`)
...
document.getElementById('withdrawal-form').addEventListener('submit', function(e) {
    ...
    const availableBalance = <?php echo e($stats['wallet']['available'] ?? 0); ?>;
    ...
    fetch('<?php echo e(route("vendor.wallet.withdrawal")); ?>', {
        method: 'POST',
        headers: {
...
function exportTransactions() {
    ...
    window.location.href = `<?php echo e(route("vendor.wallet.transactions")); ?>?${params.toString()}`;
}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Mawgood\Vendor\src\Resources\views\wallet\index.blade.php ENDPATH**/ ?>