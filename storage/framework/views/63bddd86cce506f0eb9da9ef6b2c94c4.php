...
<?php if (! $__env->hasRenderedOnce('33554447-9312-4af5-a296-389ebb232f3b')): $__env->markAsRenderedOnce('33554447-9312-4af5-a296-389ebb232f3b');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => [':src' => 'category.logo?.small_image_url || fallback',':srcset' => '`
                                ...
                                `','sizes' => '(max-width: 640px) 60px, 110px','width' => '110','height' => '110','class' => 'w-full rounded-full max-sm:h-[60px] max-sm:w-[60px]',':alt' => 'category.name','loading' => 'lazy','decoding' => 'async','fetchpriority' => 'low']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([':src' => 'category.logo?.small_image_url || fallback',':srcset' => '`
                                    ...
                                    ${(category.logo?.medium_image_url || fallback)} 110w,
                                    ${(category.logo?.large_image_url || fallback)} 300w
                                `','sizes' => '(max-width: 640px) 60px, 110px','width' => '110','height' => '110','class' => 'w-full rounded-full max-sm:h-[60px] max-sm:w-[60px]',':alt' => 'category.name','loading' => 'lazy','decoding' => 'async','fetchpriority' => 'low']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\resources\themes\mawgood\views\components\categories\carousel.blade.php ENDPATH**/ ?>