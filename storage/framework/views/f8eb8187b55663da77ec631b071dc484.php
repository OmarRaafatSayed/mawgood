    ...
    <div class="flex-auto mx-4 max-md:mx-6 max-sm:mx-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <?php if(!$vendor): ?>
                    ...
                    <a
                        href="<?php echo e(route('vendor.onboarding.form')); ?>"
                    ...
                    >
                        ...
                        <?php echo e(app()->getLocale() === 'ar' ? 'افتح متجرك' : 'Open Your Store'); ?>

                    </a>
                <?php elseif($vendor->status === 'pending'): ?>
                    <!-- Under Review Status -->
                    <a
                        href="<?php echo e(route('vendor.under-review')); ?>"
                    ...
                    >
                        ...
                        <?php echo e(app()->getLocale() === 'ar' ? 'قيد المراجعة' : 'Under Review'); ?>
        ...
        <div class="grid grid-cols-1 mt-8 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                ...
                <p class="text-sm font-medium text-zinc-500">
                    <?php if(isset($customer->user_type)): ?>
                        <?php if($customer->user_type === 'company'): ?>
                            <?php echo e(app()->getLocale() === 'ar' ? 'شركة' : 'Company'); ?>

                        <?php elseif($customer->user_type === 'vendor'): ?>
                            <?php echo e(app()->getLocale() === 'ar' ? 'بائع متجر' : 'Store Vendor'); ?>

                        <?php else: ?>
                            <?php echo e(app()->getLocale() === 'ar' ? 'عميل عادي' : 'Regular Customer'); ?>
            ...
            <?php if(isset($customer->company_description) && $customer->company_description): ?>
                <!-- Company Description -->
                <div class="grid w-full grid-cols-[2fr_3fr] border-b border-zinc-200 px-8 py-3 max-md:px-0">
                    <p class="text-sm font-medium">
                    ...
                    <p class="text-sm font-medium text-zinc-500">
                        <?php echo e($customer->company_description); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Shop\src/resources/views/customers/account/profile/index.blade.php ENDPATH**/ ?>