...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('8c568e8e-1e9e-47d4-95fc-3b12c555b345')): $__env->markAsRenderedOnce('8c568e8e-1e9e-47d4-95fc-3b12c555b345');
...
<?php endif; ?>
                                ...
                                <template v-else>
                                    ...
                                    <div class="flex items-center gap-5 py-2.5">
                                        <img
                                            src="<?php echo e(asset('vendor/webkul/admin/assets/images/settings/address.svg')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\customers\customers\view.blade.php ENDPATH**/ ?>