...
<a href="<?php echo e(route('shop.customers.account.profile.index')); ?>" class="p-2 text-primary">
...
<p class="text-sm text-gray-600">ابدأ البيع وحقق أرباحك معانا</p>
        ...
        <form action="<?php echo e(route('vendor.onboarding.submit')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="store_description" id="store_description" rows="4" 
                                  ...
                                  class="w-full px-4 py-3 rounded-lg border border-primary/20 focus:border-accent-gold focus:outline-none" required><?php echo e(old('store_description')); ?></textarea>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="business_address" id="business_address" rows="3" 
                                  ...
                                  class="w-full px-4 py-3 rounded-lg border border-primary/20 focus:border-accent-gold focus:outline-none" required><?php echo e(old('business_address')); ?></textarea>
                    </div>
                </div>
            </div>
