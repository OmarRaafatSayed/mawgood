...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('46826701-c2da-4942-88d0-d1d1441c3cb7')): $__env->markAsRenderedOnce('46826701-c2da-4942-88d0-d1d1441c3cb7');
...
<?php $component->withAttributes(['type' => 'select','name' => 'target_currency','rules' => 'required','v-model' => 'selectedExchangeRate.target_currency','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.settings.exchange-rates.index.create.target-currency'))]); ?>
                                    ...
                                    <option
                                        ...
                                        v-show="currency.code !== '<?php echo e(core()->getBaseCurrencyCode()); ?>'"
                                    >
                                        {{ currency.name }}
                                    </option>
                                 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src/resources/views/settings/exchange-rates/index.blade.php ENDPATH**/ ?>