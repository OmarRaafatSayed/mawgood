...
function renderProducts(products) {
    ...
    grid.innerHTML = products.map(p => `
        <div class="flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
            <div class="relative aspect-[4/5] bg-slate-50">
                ...
                <button onclick="toggleWishlist(${p.id})" class="absolute top-2 right-2 size-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-sm">
            ...
            <div class="p-3 flex flex-col flex-1">
                ...
                <div class="mt-auto flex items-center justify-between">
                    ...
                    <button onclick="addToCart(${p.id})" class="size-9 rounded-full bg-primary text-white flex items-center justify-center shadow-md active:scale-95 transition-transform">
