...
<?php if (! $__env->hasRenderedOnce('851d48f5-1466-44ea-a04e-73966fd9066f')): $__env->markAsRenderedOnce('851d48f5-1466-44ea-a04e-73966fd9066f');
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                src="<?php echo e(asset('vendor/webkul/admin/assets/images/total-sales.svg')); ?>"
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                src="<?php echo e(asset('vendor/webkul/admin/assets/images/total-orders.svg')); ?>"
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                src="<?php echo e(asset('vendor/webkul/admin/assets/images/customers.svg')); ?>"
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                src="<?php echo e(asset('vendor/webkul/admin/assets/images/average-orders.svg')); ?>"
                    ...
                    <div class="flex min-w-[200px] flex-1 gap-2.5">
                        <div class="h-[60px] max-h-[60px] w-full max-w-[60px] dark:mix-blend-exclusion dark:invert">
                            <img
                                src="<?php echo e(asset('vendor/webkul/admin/assets/images/unpaid-invoices.svg')); ?>"
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src/resources/views/dashboard/over-all-details.blade.php ENDPATH**/ ?>