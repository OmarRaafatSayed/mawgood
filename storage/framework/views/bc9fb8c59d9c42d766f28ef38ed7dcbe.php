    ...
    <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-x-1.5">
            ...
            <div class="flex items-center gap-2 ltr:ml-3 rtl:mr-3">
                <a href="<?php echo e(route('shop.search.index')); ?>" class="px-3 py-1.5 rounded-md bg-navyBlue text-white text-xs font-medium shadow-sm hover:shadow-md transition">Shop</a>
                <a href="<?php echo e(route('jobs.index')); ?>" class="px-3 py-1.5 rounded-md bg-navyBlue text-white text-xs font-bold shadow-sm hover:shadow-md transition">Jobs</a>
            </div>
        </div>
...
<?php if (! $__env->hasRenderedOnce('f8587222-f782-4549-8842-356bad6da805')): $__env->markAsRenderedOnce('f8587222-f782-4549-8842-356bad6da805');
...
<?php $component->withAttributes(['position' => 'left','width' => '100%','@close' => 'onDrawerClose']); ?>
             ...
             <?php $__env->slot('footer', null, []); ?> 
                ...
                <?php if((core()->getCurrentChannel()->locales ?? collect())->count() > 1 || (core()->getCurrentChannel()->currencies ?? collect())->count() > 1 ): ?>
                            ...
                            <!-- Drawer Toggler -->
                             <?php $__env->slot('toggle', null, []); ?> 
                                <div
                                    ...
                                    role="button"
                                >
                                    <?php echo e((data_get(core()->getCurrentCurrency(), 'symbol') ?? '') . ' ' . core()->getCurrentCurrencyCode()); ?>
