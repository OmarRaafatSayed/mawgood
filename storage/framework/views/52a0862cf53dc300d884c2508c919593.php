...
<?php $__env->startSection('page-icon', '<i class="fas fa-box me-2"></i>'); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="total-products"><?php echo e($stats['products']['total'] ?? 0); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="active-products"><?php echo e($stats['products']['active'] ?? 0); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="pending-products"><?php echo e($stats['products']['inactive'] ?? 0); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0" id="low-stock-products"><?php echo e($stats['products']['low_stock'] ?? 0); ?></h2>
                    </div>
        ...
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-2">
                ...
                <select class="form-select" name="stock">
                    ...
                    <option value="in_stock" <?php echo e(request('stock') == 'in_stock' ? 'selected' : ''); ?>>متوفر</option>
                    <option value="low" <?php echo e(request('stock') == 'low' ? 'selected' : ''); ?>>منخفض</option>
                    <option value="out" <?php echo e(request('stock') == 'out' ? 'selected' : ''); ?>>نفد</option>
                </select>
            </div>
            <div class="col-md-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="<?php echo e($product->image_url ?? asset('images/placeholder.png')); ?>" 
                                 alt="<?php echo e($product->name); ?>" class="rounded" style="width: 50px; height: 50px; object-fit: cover;">
                        </td>
                        <td>
                            <div>
                        ...
                        <td><code><?php echo e($product->sku ?? 'N/A'); ?></code></td>
                        <td>
                        ...
                        <td><?php echo e($product->created_at ? \Carbon\Carbon::parse($product->created_at)->format('Y-m-d') : 'N/A'); ?></td>
                        <td>
                            <div class="btn-group" role="group">
                                <a href="<?php echo e(route('vendor.products.show', $product->id)); ?>" class="btn btn-sm btn-outline-info" title="عرض">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('vendor.products.edit', $product->id)); ?>" class="btn btn-sm btn-outline-primary" title="تعديل">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteProduct(<?php echo e($product->id); ?>)" title="حذف">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('vendor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Mawgood\Vendor\src\Providers/../Resources/views/products/index.blade.php ENDPATH**/ ?>