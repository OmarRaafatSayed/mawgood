...
<?php if (! $__env->hasRenderedOnce('96f981dd-78d7-4d48-a9f8-36fbb2d2173e')): $__env->markAsRenderedOnce('96f981dd-78d7-4d48-a9f8-36fbb2d2173e');
    ...
    >
        <div class="box-shadow relative rounded bg-white dark:bg-gray-900">
            ...
            >
                <!-- Placeholder Image -->
                <img
                    src="<?php echo e(asset('vendor/webkul/admin/assets/images/icon-options.svg')); ?>"
                            ...
                            <div class="flex gap-2.5">
                                ...
                                >
                                    <template v-if="! element.product.images.length">
                                        <img src="<?php echo e(asset('vendor/webkul/admin/assets/images/product-placeholders/front.svg')); ?>">
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\catalog\products\edit\types\bundle.blade.php ENDPATH**/ ?>