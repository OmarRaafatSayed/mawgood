...
<html
    ...
    dir="<?php echo e($locale->direction); ?>"
>
...
<head>
    ...
    <meta
        name="currency"
        content="<?php echo e(json_encode($baseCurrency)); ?>"
    >
    ...
    <?php else: ?>
        <link
            type="image/x-icon"
            href="<?php echo e(asset('vendor/webkul/admin/assets/images/favicon.ico')); ?>"
            rel="shortcut icon"
            sizes="16x16"
        />
    <?php endif; ?>
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\components\layouts\index.blade.php ENDPATH**/ ?>