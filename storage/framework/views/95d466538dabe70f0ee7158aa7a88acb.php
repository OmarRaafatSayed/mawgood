...
<?php if (! $__env->hasRenderedOnce('02158240-7555-4b61-b06b-608ae5f733dc')): $__env->markAsRenderedOnce('02158240-7555-4b61-b06b-608ae5f733dc');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'after:content-[\' \'] relative bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'product.base_image.medium_image_url',':srcset' => '`
                        ...
                        `','sizes' => '(max-width: 768px) 150px, (max-width: 1200px) 300px, 600px',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name','loading' => 'lazy','decoding' => 'async','fetchpriority' => 'low']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['class' => 'after:content-[\' \'] relative bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'product.base_image.medium_image_url',':srcset' => '`
                            ${product.base_image.small_image_url} 150w,
                            ${product.base_image.medium_image_url} 300w,
                        `','sizes' => '(max-width: 768px) 150px, (max-width: 1200px) 300px, 600px',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name','loading' => 'lazy','decoding' => 'async','fetchpriority' => 'low']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'after:content-[\' \'] relative min-w-[250px] bg-zinc-100 transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105',':src' => 'product.base_image.medium_image_url',':key' => 'product.id',':index' => 'product.id','width' => '291','height' => '300',':alt' => 'product.name','loading' => 'lazy','decoding' => 'async','fetchpriority' => 'low']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3657c70d06ebc8c078f4ecac2ea1a848)): ?>
<?php $attributes = $__attributesOriginal3657c70d06ebc8c078f4ecac2ea1a848; ?>
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\resources\themes\mawgood\views\components\products\card.blade.php ENDPATH**/ ?>