...
<?php $component->withAttributes([]); ?>
	...
	<div class="flex h-[100vh] items-center justify-center bg-white dark:bg-gray-900">
        <div class="flex max-w-[745px] items-center gap-5">
            ...
            <div class="w-full">
                <img src="<?php echo e(asset('vendor/webkul/admin/assets/images/error.svg')); ?>" />
            </div>
        </div>
	</div>
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\errors\index.blade.php ENDPATH**/ ?>