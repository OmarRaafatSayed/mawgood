                 ...
                 <?php $__env->slot('content', null, ['v-pre' => true]); ?> 
                    <div class="flex flex-col <?php echo e($order->billing_address ? 'pb-4' : ''); ?>">
                        <p 
                            ...
                            v-text="'<?php echo e($invoice->order->customer_full_name); ?>'"
                        >
                        </p>
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\sales\invoices\view.blade.php ENDPATH**/ ?>