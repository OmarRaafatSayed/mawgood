...
<?php if (! $__env->hasRenderedOnce('4af5449c-897d-4e13-8bf7-819ed85cf5fe')): $__env->markAsRenderedOnce('4af5449c-897d-4e13-8bf7-819ed85cf5fe');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.dropdown.index','data' => ['position' => 'bottom-'.e($locale->direction === 'ltr' ? 'left' : 'right').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['position' => 'bottom-'.e($locale->direction === 'ltr' ? 'left' : 'right').'']); ?>
                <!-- Dropdown Toggler -->
                 <?php $__env->slot('toggle', null, []); ?> 
                    ...
                    >
                        <span>
                            <?php echo e($currentCurrency->symbol . ' ' . core()->getCurrentCurrencyCode()); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal6eb652d0a4a36e6466d8d4f363feb553 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6eb652d0a4a36e6466d8d4f363feb553 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.dropdown.index','data' => ['position' => 'bottom-'.e($locale->direction === 'ltr' ? 'right' : 'left').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('shop::dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['position' => 'bottom-'.e($locale->direction === 'ltr' ? 'right' : 'left').'']); ?>
                 <?php $__env->slot('toggle', null, []); ?> 
                    <!-- Dropdown Toggler -->
                    <div
...
<?php endif; ?>
    ...
    <script type="module">
        ...
        app.component('v-currency-switcher', {
            ...
            data() {
                return {
                    currencies: <?php echo json_encode($currentChannel->currencies, 15, 512) ?>,
                };
            },
        ...
        app.component('v-locale-switcher', {
            ...
            data() {
                return {
                    locales: <?php echo json_encode(core()->getCurrentChannel()->locales ?? [], 15, 512) ?>,
                };
            },
...
<?php $__env->stopPush(); endif; ?><?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Shop\src/resources/views/components/layouts/header/desktop/top.blade.php ENDPATH**/ ?>