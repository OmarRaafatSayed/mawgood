...
<nav class="mobile-nav-bar">
    <a href="<?php echo e(route('shop.search.index')); ?>" class="nav-item <?php echo e(request()->routeIs('shop.search.index') ? 'active' : ''); ?>">
        <?php echo '<i class="fas fa-store"></i>'; ?>

        <span>السوق</span>
    </a>

    <a href="<?php echo e(route('shop.customers.account.index')); ?>" class="nav-item <?php echo e(request()->routeIs('shop.customers.account.*') ? 'active' : ''); ?>">
        <?php echo '<i class="fas fa-user"></i>'; ?>
    ...
    <button type="button" class="nav-item" onclick="document.getElementById('offCanvasMenu').classList.add('show')">
        <?php echo '<i class="fas fa-bars"></i>'; ?>
    ...
    <div class="off-canvas-content">
        <div class="off-canvas-header">
            ...
            <button type="button" onclick="document.getElementById('offCanvasMenu').classList.remove('show')">
                <?php echo '<i class="fas fa-times"></i>'; ?>
        ...
        <div class="off-canvas-body">
            <div class="menu-section">
                <?php if(auth()->guard('customer')->guest()): ?>
                    <a href="<?php echo e(route('shop.customer.session.create')); ?>" class="menu-link">
                        <?php echo '<i class="fas fa-sign-in-alt"></i>'; ?>

                        <span>تسجيل الدخول</span>
                    </a>
                    <a href="<?php echo e(route('shop.customers.register.index')); ?>" class="menu-link">
                        <?php echo '<i class="fas fa-user-plus"></i>'; ?>
            ...
            <div class="menu-section">
                <a href="<?php echo e(route('blog.index')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-newspaper"></i>'; ?>

                    <span>المقالات</span>
                </a>
                <a href="<?php echo e(route('jobs.index')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-briefcase"></i>'; ?>

                    <span>فرص العمل</span>
                </a>
                <a href="<?php echo e(route('shop.search.index')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-search"></i>'; ?>
            ...
            <div class="menu-section">
                <a href="<?php echo e(route('shop.cms.page', 'about-us')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-info-circle"></i>'; ?>

                    <span>من نحن</span>
                </a>
                <a href="<?php echo e(route('shop.cms.page', 'privacy-policy')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-shield-alt"></i>'; ?>

                    <span>سياسة الخصوصية</span>
                </a>
                <a href="<?php echo e(route('shop.cms.page', 'terms-of-use')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-file-contract"></i>'; ?>

                    <span>شروط الاستخدام</span>
                </a>
                <a href="<?php echo e(route('shop.cms.page', 'contact-us')); ?>" class="menu-link">
                    <?php echo '<i class="fas fa-envelope"></i>'; ?>
            ...
            <div class="menu-section social-section">
                <a href="#" class="social-link" aria-label="Facebook"><?php echo '<i class="fab fa-facebook-f"></i>'; ?></a>
                <a href="#" class="social-link" aria-label="TikTok"><?php echo '<i class="fab fa-tiktok"></i>'; ?></a>
                <a href="#" class="social-link" aria-label="YouTube"><?php echo '<i class="fab fa-youtube"></i>'; ?></a>
                <a href="#" class="social-link" aria-label="WhatsApp"><?php echo '<i class="fab fa-whatsapp"></i>'; ?></a>
                <a href="#" class="social-link" aria-label="Instagram"><?php echo '<i class="fab fa-instagram"></i>'; ?></a>
            </div>
        </div>
    </div>
</div>
...
<?php endif; ?><?php /**PATH /var/www/mawgood/packages/Webkul/Shop/src/Providers/../Resources/views/components/mobile-bottom-bar.blade.php ENDPATH**/ ?>