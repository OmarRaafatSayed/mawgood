...
>
    <head>
        ...
        <?php
            ...
            // Use DejaVu Sans - supports both Arabic and English
            $fontPath = [];
            $fontFamily = [
                'regular' => 'DejaVu Sans',
                'bold'    => 'DejaVu Sans',
    ...
    <body style="direction: ltr;">
        <div class="logo-container <?php echo e(core()->getCurrentLocale()->direction); ?>">
            <?php if(core()->getConfigData('sales.invoice_settings.pdf_print_outs.logo')): ?>
                <?php
                    $logoPath = storage_path('app/public/' . core()->getConfigData('sales.invoice_settings.pdf_print_outs.logo'));
                ?>
                <?php if(file_exists($logoPath)): ?>
                    <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents($logoPath))); ?>" style="max-width: 150px;"/>
                <?php endif; ?>
            <?php else: ?>
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\sales\invoices\pdf.blade.php ENDPATH**/ ?>