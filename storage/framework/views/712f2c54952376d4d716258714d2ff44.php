    ...
    <div class="flex h-[100vh] items-center justify-center">
        <div class="flex flex-col items-center gap-5">
            ...
            <?php else: ?>
                <img
                    class="w-max" 
                    src="<?php echo e(asset('vendor/webkul/admin/assets/images/logo.svg')); ?>"
                    alt="<?php echo e(config('app.name')); ?>"
                />
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src\Resources\views\users\forget-password\create.blade.php ENDPATH**/ ?>