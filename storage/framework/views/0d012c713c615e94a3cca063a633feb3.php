...
<?php $component->withAttributes(['position' => 'bottom-'.e(core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left').'']); ?>
             <?php $__env->slot('toggle', null, []); ?> 
                <?php if(isset($admin) && $admin && $admin->image): ?>
                ...
                <?php elseif(isset($vendorForCustomer) && $vendorForCustomer && $vendorForCustomer->store_logo): ?>
                    <button class="flex h-8 w-8 cursor-pointer overflow-hidden rounded-full hover:opacity-80 focus:opacity-80 sm:h-9 sm:w-9">
                        <img
                            src="<?php echo e(Storage::url($vendorForCustomer->store_logo)); ?>"
                            class="h-full w-full object-cover"
                            alt="<?php echo e($vendorForCustomer->store_name); ?>"
                        />
                    </button>
                <?php else: ?>
                    <button class="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-blue-400 text-xs font-semibold leading-6 text-white transition-all hover:bg-blue-500 focus:bg-blue-500 sm:h-9 sm:w-9 sm:text-sm">
                        <?php echo e(isset($admin) && $admin ? substr($admin->name, 0, 1) : (isset($vendorForCustomer) && $vendorForCustomer ? substr($vendorForCustomer->store_name, 0, 1) : (isset($customer) && $customer ? substr($customer->first_name ?? $customer->name ?? $customer->email, 0, 1) : '?'))); ?>
...
<?php endif; ?>
                    ...
                    <?php elseif(isset($vendorForCustomer) && $vendorForCustomer): ?>
                        <a
                            class="cursor-pointer px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-950 sm:px-5 sm:text-base"
                            href="<?php echo e(route('vendor.settings.index')); ?>"
                        >
                            <?php echo e(app()->getLocale() === 'ar' ? 'حساب التاجر' : 'Merchant Account'); ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal81b4d293d9113446bb908fc8aef5c8f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal81b4d293d9113446bb908fc8aef5c8f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.index','data' => ['method' => 'DELETE','action' => ''.e(route('shop.customer.session.destroy')).'','id' => 'customerLogout']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin::form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        >
                            <?php echo e(app()->getLocale() === 'ar' ? 'حسابي' : 'My Account'); ?>
...
<?php if (! $__env->hasRenderedOnce('980693ce-e394-4250-a758-14d6e2802ed1')): $__env->markAsRenderedOnce('980693ce-e394-4250-a758-14d6e2802ed1');
                                ...
                                <div class="flex gap-2 sm:gap-2.5">
                                    ...
                                    >
                                        <template v-if="! product.images.length">
                                            <img src="<?php echo e(bagisto_asset_safe('images/product-placeholders/front.svg')); ?>" class="h-full w-full object-cover">
            ...
            data() {
                return {
                    isDarkMode: <?php echo e(request()->cookie('dark_mode') ?? 0); ?>,
                                    ...
                                    ?>
                    logo: "<?php echo e($logoAsset); ?>",

                    dark_logo: "<?php echo e($darkLogoAsset); ?>",
                };
            },
...
<?php /**PATH C:\Users\EXPRESS\Downloads\coding\mawgood\mawgood\packages\Webkul\Admin\src/resources/views/components/layouts/header/index.blade.php ENDPATH**/ ?>