...
<title>تسجيل الدخول - موجود</title>
...
<main class="max-w-md mx-auto px-4 py-12 pb-24 lg:py-16">
<div class="bg-white rounded-2xl shadow-lg p-8">
<div class="text-center mb-8">
<h1 class="text-3xl font-bold text-primary mb-2">مرحباً بعودتك</h1>
...
<a href="{{ route('shop.customers.forgot_password.create') }}" class="text-sm text-primary hover:underline">نسيت كلمة المرور؟</a>
</div>

<button type="submit" class="w-full py-3 bg-gradient-to-r from-primary to-orange-600 text-white font-bold rounded-xl hover:shadow-lg transition-all">تسجيل الدخول</button>
</div>
</x-shop::form>
...
<span class="absolute bg-white px-4 text-sm text-gray-500">أو</span>
</div>
<a href="{{ route('customer.social-login.index', 'google') }}" class="flex items-center justify-center gap-3 rounded-xl border-2 border-gray-200 px-4 py-3 hover:bg-gray-50 transition-all">
...
<p class="mt-6 text-center text-sm text-gray-600">ليس لديك حساب؟ <a href="{{ route('shop.customers.register.index') }}" class="text-primary font-medium hover:underline">إنشاء حساب</a></p>
</div>
</main>
